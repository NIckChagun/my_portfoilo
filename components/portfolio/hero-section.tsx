  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto w-full max-w-5xl pt-24">
        {/* Profile Image Row */}
        <div className="fade-up opacity-0 translate-y-8 transition-all duration-700 ease-out [&.animate-in]:opacity-100 [&.animate-in]:translate-y-0 mb-10 flex justify-center">
          <div className="relative">
            <div className="absolute -inset-1 rounded-full bg-gradient-to-br from-primary/60 to-primary/20 blur-sm" />
            <div className="relative h-40 w-40 overflow-hidden rounded-full border-2 border-primary/30 md:h-48 md:w-48">
              <Image
                src="/images/profile.jpg"
                alt="Warunyu Jantree - Full Stack Developer"
                fill
        ...
        <div className="text-center">
          ...
          <div className="fade-up opacity-0 translate-y-8 transition-all duration-700 delay-[400ms] ease-out [&.animate-in]:opacity-100 [&.animate-in]:translate-y-0">
          ...
          {/* Scroll indicator */}
          <div className="fade-up opacity-0 translate-y-8 transition-all duration-700 delay-[600ms] ease-out [&.animate-in]:opacity-100 [&.animate-in]:translate-y-0 mt-16">
